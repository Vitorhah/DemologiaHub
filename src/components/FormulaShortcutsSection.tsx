...
export function FormulaShortcutsSection({
  ...
  return (
    <div className="w-full max-w-xl mx-auto bg-[var(--op-panel)] border border-[var(--op-border)] rounded-none p-4 sm:p-6 shadow-xl relative overflow-hidden">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-3.5 sm:pb-4 mb-4 sm:mb-5 border-b border-[var(--op-border)]">
        <div>
          <div className="flex items-center gap-2 sm:gap-2.5">
            <span className="w-2.5 h-2.5 rounded-none bg-[var(--op-red-bright)] shadow-[0_0_8px_#b81d24]" />
      ...
      {isFormOpen && (
        <form
          onSubmit={handleSave}
          className="mb-4 sm:mb-5 p-4 sm:p-5 bg-gradient-to-b from-[#1c0a0d] via-[#140608] to-[#0f0406] border border-[#851a21] rounded-none shadow-2xl relative overflow-hidden"
        >
          <div className="flex items-center justify-between pb-2.5 mb-3.5 border-b border-[#3d0f14]">
            ...
            <button
              ...
              className="p-1.5 rounded-none text-[var(--op-text-muted)] hover:text-white hover:bg-white/10 transition-colors touch-manipulation"
            >
              <X size={16} />
            </button>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-4">
            <div>
              ...
              <input
                ...
                className="w-full bg-[#0a0a0d] border border-[var(--op-border)] focus:border-[var(--op-red-bright)] focus:ring-1 focus:ring-[var(--op-red-bright)] rounded-none px-3 py-2.5 text-base sm:text-sm font-mono text-white placeholder:text-[#555] outline-none transition-all"
                autoFocus
              />
            </div>
          ...
          <div className="flex flex-col-reverse sm:flex-row items-stretch sm:items-center justify-end gap-2 sm:gap-2.5 pt-1">
            <button
              ...
              className="px-4 py-2.5 sm:py-2 text-xs font-mono uppercase tracking-wider text-[var(--op-text-muted)] hover:text-white bg-[#14141a] hover:bg-[#20202a] rounded-none border border-[var(--op-border)] transition-colors cursor-pointer text-center min-h-[42px] touch-manipulation select-none"
            >
              Cancelar
            </button>
            <button
      ...
      {shortcuts.length === 0 ? (
        <div className="py-8 sm:py-10 px-4 border border-dashed border-[var(--op-border)] rounded-none text-center bg-[#0d0d12]/50 flex flex-col items-center justify-center">
          <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-none bg-[#1c080b] border border-[#541217] flex items-center justify-center text-[var(--op-red-bright)] shadow-[0_0_16px_rgba(184,29,36,0.25)] mb-3">
            <Dices size={26} />
          </div>
          ...
          {shortcuts.map((sc) => (
            ...
            >
              ...
              <div className="flex items-center gap-3 min-w-0 pr-2">
                <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-none bg-[#21090c] border border-[#521016] group-hover:border-[var(--op-red-bright)] flex items-center justify-center text-[var(--op-red-bright)] group-hover:shadow-[0_0_10px_rgba(184,29,36,0.5)] shrink-0 transition-all">
                  <Dices size={17} />
                </div>
              ...
              <div className="flex items-center gap-0.5 sm:gap-1 shrink-0">
                <button
                  ...
                  className="w-10 h-10 sm:w-8 sm:h-8 flex items-center justify-center rounded-none hover:bg-white/10 active:bg-white/20 text-[var(--op-text-muted)] hover:text-white transition-colors cursor-pointer touch-manipulation"
                >
                ...
                <button
                  ...
                  className="w-10 h-10 sm:w-8 sm:h-8 flex items-center justify-center rounded-none hover:bg-red-950/60 active:bg-red-900 text-[var(--op-text-muted)] hover:text-red-400 transition-colors cursor-pointer touch-manipulation"
                >
                  <Trash2 size={15} />
                </button>
              </div>
